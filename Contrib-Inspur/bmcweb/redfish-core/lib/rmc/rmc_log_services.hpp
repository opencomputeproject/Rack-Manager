...
#else
        asyncResp->res.jsonValue["@odata.id"] =
            "/redfish/v1/Managers/rmc/LogServices";
        asyncResp->res.jsonValue["Name"] = "Open RMC Log Services Collection";
        asyncResp->res.jsonValue["Description"] =
            "Collection of LogServices for this Manager";
        logServiceArray.push_back({{"@odata.id", "/redfish/v1/Managers/rmc/LogServices/LogService"}});
#endif
// #ifdef BMCWEB_ENABLE_REDFISH_BMC_JOURNAL
//         asyncResp->res.jsonValue["@odata.id"] =
//             "/redfish/v1/Managers/rmc/LogServices";
...
//         logServiceArray.push_back(
//             {{ "@odata.id",
//                "/redfish/v1/Managers/rmc/LogServices/LogService" }});
// #endif
        asyncResp->res.jsonValue["Members@odata.count"] =
            logServiceArray.size();
    }
...
class BMCJournalLogService : public Node
{
...
#else
        Node(app, "/redfish/v1/Managers/rmc/LogServices/LogService/")
#endif // !BMCWEB_ENABLE_REDFISH_RMC
    {
        entityPrivileges = {
            {boost::beast::http::verb::get, {{"Login"}}},
  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        asyncResp->res.jsonValue["@odata.context"] =
            "/redfish/v1/$metadata#LogService.LogService";
        asyncResp->res.jsonValue["Name"] = "Open RMC LogService Log Service";
        asyncResp->res.jsonValue["Description"] = "RMC LogService Log Service";
        asyncResp->res.jsonValue["Id"] = "RMC LogService";
        asyncResp->res.jsonValue["OverWritePolicy"] = "WrapsWhenFull";
        asyncResp->res.jsonValue["Entries"] = {
            {"@odata.id",
            "/redfish/v1/Managers/rmc/LogServices/LogService/Entries"}};
#endif
    }
};
#ifndef BMCWEB_ENABLE_REDFISH_RMC
...
// Fill in the log entry with the gathered data
    bmcJournalLogEntryJson = {
        {"@odata.type", "#LogEntry.v1_4_0.LogEntry"},
        {"@odata.context", "/redfish/v1/$metadata#LogEntry.LogEntry"},
        {"@odata.id", "/redfish/v1/Managers/rmc/LogServices/LogService/Entries/" +
                          bmcJournalLogEntryID},
        {"Name", "BMC Journal Entry"},
        {"Id", bmcJournalLogEntryID},
        {"Message", msg},
...
class BMCJournalLogEntryCollection : public Node
{
...
#else
        Node(app, "/redfish/v1/Managers/rmc/LogServices/LogService/Entries/")
#endif // !BMCWEB_ENABLE_REDFISH_RMC
    {
        entityPrivileges = {
            {boost::beast::http::verb::get, {{"Login"}}},
  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        asyncResp->res.jsonValue["@odata.context"] =
            "/redfish/v1/$metadata#LogEntryCollection.LogEntryCollection";
        asyncResp->res.jsonValue["Name"] = "Open RMC LogService Entries";
        asyncResp->res.jsonValue["Description"] =
            "Collection of RMC LogService Entries";
        nlohmann::json &logEntryArray = asyncResp->res.jsonValue["Members"];
        logEntryArray = nlohmann::json::array();
        logEntryArray.push_back(
            {{"@odata.id", "/redfish/v1/Managers/rmc/LogServices/LogService/Entries/entry1"}});
        logEntryArray.push_back(
            {{"@odata.id", "/redfish/v1/Managers/rmc/LogServices/LogService/Entries/entry2"}});
...
class BMCJournalLogEntry : public Node
{
  public:
    BMCJournalLogEntry(CrowApp &app) :
        ...
        Node(app, "/redfish/v1/Managers/bmc/LogServices/Journal/Entries/<str>/",
             std::string())
#else
        Node(app, "/redfish/v1/Managers/rmc/LogServices/LogService/Entries/<str>/",
             std::string())
#endif // !BMCWEB_ENABLE_REDFISH_RMC
  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        asyncResp->res.jsonValue["@odata.id"] =
            "/redfish/v1/Managers/rmc/LogServices/LogService/Entries/" + entryID;
        asyncResp->res.jsonValue["@odata.context"] = "/redfish/v1/$metadata#LogEntry.LogEntry";
        asyncResp->res.jsonValue["Name"] = "Open RMC LogService Entry";
        asyncResp->res.jsonValue["Id"]   = entryID;
        asyncResp->res.jsonValue["OemRecordFormat"] = "RMC LogService Entry";
        asyncResp->res.jsonValue["Created"]   = "2019-07-23T14:44:00Z00:00";
        asyncResp->res.jsonValue["EntryType"] = "Event";
        asyncResp->res.jsonValue["MessageId"] = "Contoso.1.0.TempAssert";
        asyncResp->res.jsonValue["Message"]   = "This is RMC Message";
        asyncResp->res.jsonValue["Severity"]  = "OK";

        if("entry2" == entryID)
        {
            asyncResp->res.jsonValue["Created"]   = "2020-09-01T14:44:00Z00:00";
            asyncResp->res.jsonValue["EntryType"] = "Event";
            asyncResp->res.jsonValue["MessageId"] = "Contoso.1.0.TempAssert";
            asyncResp->res.jsonValue["Message"]   = "This is RMC Message";
            asyncResp->res.jsonValue["Severity"]  = "Critical";
        }

        // asyncResp->res.jsonValue["LogEntry"]["Created"]   = "2012-03-07T14:44:00Z";
        // asyncResp->res.jsonValue["LogEntry"]["EntryType"] = "Event";
        // asyncResp->res.jsonValue["LogEntry"]["Message"]   = "This is RMC Message";
        // asyncResp->res.jsonValue["LogEntry"]["Severity"]  = "OK";

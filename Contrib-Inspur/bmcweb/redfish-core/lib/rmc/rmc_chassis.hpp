            ...
            [asyncResp](const boost::system::error_code ec,
                ...
                for (const std::string &objpath : chassisList)
                {
                    ...
                    chassisArray.push_back(
                        {{ "@odata.id",
                           "/redfish/v1/Chassis/" + objpath.substr(lastPos + 1)
                        }});
                }
...
void getChassis(std::shared_ptr<AsyncResp> asyncResp,
               ...
               const std::vector<std::string> &params) override
    {
        ...
        res.jsonValue["@odata.id"]      = std::string("/redfish/v1/Chassis/") + chassisId;
        res.jsonValue["@odata.context"] = "/redfish/v1/$metadata#Chassis.Chassis";
        ...
        res.jsonValue["ManagedBy"]      = {{"@odata.id", "/redfish/v1/Managers/rmc"}};

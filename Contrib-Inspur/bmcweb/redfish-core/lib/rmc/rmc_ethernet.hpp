  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        res.jsonValue["@odata.context"] =
            ...
            "$metadata#EthernetInterfaceCollection.EthernetInterfaceCollection";
        res.jsonValue["@odata.id"] =
            "/redfish/v1/Managers/rmc/EthernetInterfaces";
        ...
        const boost::container::flat_set<IPv6AddressData> &ipv6Data)
    {
...
#else
        json_response["@odata.id"] =
            "/redfish/v1/Managers/rmc/EthernetInterfaces/" + iface_id;
#endif
        ...
        json_response["VLANs"] = {
            {"@odata.id", "/redfish/v1/Managers/bmc/EthernetInterfaces/" +
                              iface_id + "/VLANs"}};
#else
       json_response["FQDN"] = "www.inspur.com";
       nlohmann::json &NameServers_array = json_response["NameServers"];
       NameServers_array.push_back({"www.china.com", "www.inspur.com"});
#endif 
...
#else
        json_response["@odata.id"] =
            "/redfish/v1/Managers/rmc/EthernetInterfaces/" + parent_iface_id +
            "/VLANs/" + iface_id;
#endif // !BMCWEB_ENABLE_REDFISH_RMC

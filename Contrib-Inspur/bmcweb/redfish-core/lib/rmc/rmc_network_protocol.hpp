...
class NetworkProtocol : public Node
{
  ...
  private:
    ...
    void getData(const std::shared_ptr<AsyncResp>& asyncResp)
    {
        ...
        asyncResp->res.jsonValue["SSH"]["ProtocolEnable"] = true;
        asyncResp->res.jsonValue["SSH"]["ProtocolEnabled"] = true;
        asyncResp->res.jsonValue["HTTP"]["ProtocolEnable"] = true;
        asyncResp->res.jsonValue["HTTP"]["ProtocolEnabled"] = true;
        asyncResp->res.jsonValue["HTTP"]["Port"] = "80";
        asyncResp->res.jsonValue["HTTPS"]["ProtocolEnable"] = true;
        asyncResp->res.jsonValue["HTTPS"]["ProtocolEnabled"] = true;
        asyncResp->res.jsonValue["HTTPS"]["Port"] = "443";
#endif
